...
public class ManageRestaurantsWorkArena extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArrayList<Restaurant> rests = rd.getRestaurantList();
        rests.removeIf((Restaurant r) -> r.getUserAccount().getUsername() == userName);
    ...
    private void populateTable() {
        rd = ecosystem.getRestaurantDirectory();
        if(rd == null){
            JOptionPane.showMessageDialog(this, "No Restaurants in the system");
        }
        DefaultTableModel df = (DefaultTableModel) restosTable.getModel();
